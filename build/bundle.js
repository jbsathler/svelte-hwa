var app = (function () {
    ...
    /* src/components/HowTo.svelte generated by Svelte v3.26.0 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="assets/handwashing.gif" alt="How to wash your hands." class="svelte-wwxt9"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src/components/ProgressBar.svelte generated by Svelte v3.26.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-ag7q4m");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-ag7q4m");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src/components/Timer.svelte generated by Svelte v3.26.0 */
  ...
  <a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source</a>`;
    			...
    			audio_1.innerHTML = `<source src="assets/sound.wav"/><track kind="captions"/>`;
